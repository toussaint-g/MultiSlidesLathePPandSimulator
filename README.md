# MultiSlidesLathePPandSimulator

## Auteur
**Toussaint Guillaume**

## Description
Ce projet a pour objectif de fournir une application capable d'analyser un programme de machine CNC de décolletage.
...
### Test
Pour tester l'application, vous pouvez utilier les fihciers présents dans le répertoire "data_testing".
